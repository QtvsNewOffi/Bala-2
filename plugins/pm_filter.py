...
async def pm_text(bot, message):
    ...
    await message.reply_text("<b>ᴘʟᴇᴀsᴇ ᴊᴏɪɴ ᴀɴᴅ sᴇᴀʀᴄʜ ᴍᴏᴠɪᴇ ɪɴ ᴛʜᴇ ɢʀᴏᴜᴘ  📌 https://t.me/+wSMAovOIqANiNjRl 📌             ᴀᴅᴍɪɴ 😎 -  @Itsking_45</b>")
    ...
    if query.data.startswith("file"):
                    ...
                    if IS_VERIFY and not await check_verification(client, query.from_user.id):
                        ...
                        await client.send_cached_media(
                            ...
                            reply_markup=InlineKeyboardMarkup(
                                ...
                                InlineKeyboardButton("Bᴏᴛ Oᴡɴᴇʀ", url="t.me/Anand_2K")
                                ]
                                ]
                            )
                        )
        ...
        await query.message.edit_text(
            ...
            btn = [[
                    ...
                    InlineKeyboardButton("Cᴏɴᴛᴀᴄᴛ", url="t.me/Anand_2K")
                  ]]
            await client.edit_message_media(
                query.message.chat.id, 
                query.message.id, 
